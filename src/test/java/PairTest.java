...
public class PairTest {
    ...
    public void methodsCheck() {
        ...
        Assert.
                assertTrue("Not all required methods are implemented!", requiredMethodsCount >= 5);
    }
    ...
    public void getFirstMethodTest() {
        Assert.assertEquals(5, firstPair.getGetFirst());
        Assert.assertEquals(2, secondPair.getGetFirst());
    }
